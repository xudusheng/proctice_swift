...
//        注意block的类型，UIView的方法中已经直接声明好参数和返回值。Aspects为了灵活则直接声明为了一个id对象。id对应为swift中的AnyObject对象。所以在swift中为了正常使用这个方法，需要将闭包转换为AnyObject。代码如下：
        ...
        do{
            try ViewController.aspect_hookSelector(#selector(ViewController.tableView(_:didSelectRowAtIndexPath:)), withOptions: AspectOptions.PositionAfter, usingBlock:wrappedObject);
